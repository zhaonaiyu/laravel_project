...
function sendsphone($p){
		...
		$options['accountsid']='2f12a5d0b8813cff91e67e05be9e4344';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='dc7053925072eda794abda5dccf3a0b0';

		//初始化 $options必填
		$ucpass = new Ucpaas($options);


		$appid = "927cd61a27b944348b001d93794bd041";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "481485";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
		//发送的校验码
