  ...
  <div class="center"> 
    ...
    <div class="main-wrap"> 
     <div class="user-address"> 
      ...
      <ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails"> 
       ...
       <li class="user-addresslist defaultAddr"> <span class="new-option-r"><i class="am-icon-check-circle"></i>设为默认</span> <p class="new-tit new-p-re"> <span class="new-txt">小叮当</span> <span class="new-txt-rd2">159****1622</span> </p> 
     <div class="new-mu_l2a new-p-re"> 
      <p class="new-mu_l2cw"> <span class="title">地址：</span> <span class="province">湖北</span>省 <span class="city">武汉</span>市 <span class="dist">洪山</span>区 <span class="street">雄楚大道666号(中南财经政法大学)</span></p> 
        ...
        @foreach($ress as $row)
        <li class="user-addresslist"> <span class="new-option-r"><i class="am-icon-check-circle"></i>默认地址</span> <p class="new-tit new-p-re"> <span class="new-txt">{{$row->name}}</span> <span class="new-txt-rd2">{{$row->phone}}</span> </p> 
        <div class="new-mu_l2a new-p-re"> 
         <p class="new-mu_l2cw"> <span class="title">地址：</span> <span class="province">{{$row->huo}}</span>区 <span class="street">{{$row->xhuo}}</span></p> 
        </div> 
     <div class="new-addr-btn"> 
      <a href="#"><i class="am-icon-edit"></i>编辑</a> 
      <span class="new-addr-bar">|</span> 
   ...
   <aside class="menu"> 
    <ul> 
     ...
     <li class="person"> <a href="/homeperson">个人资料</a> 
      <ul> 
       <li> <a href="/homeperson">个人信息</a></li> 
       <li> <a href="#">安全设置</a></li> 
       <li class="active"> <a href="/homeperson/show">收货地址</a></li> 
      </ul> </li> 
