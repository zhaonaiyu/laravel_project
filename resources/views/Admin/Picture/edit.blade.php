...
<article class="page-container">
	...
	<form action="/pictures/update" enctype="multipart/form-data" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				...
				<select name="status" class="select" size="1" id="">
					<option {{$picture->status=="禁用"?"selected":""}} value="0">禁用</option>
					<option {{$picture->status=="开启"?"selected":""}} value="1">开启</option>
				</select>
