		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			@foreach($role as $row)
				<tr class="text-c">
					...
					<a style="text-decoration:none" class="ml-5" onClick="article_edit('分配权限','article-add.html','10001')" href="/adminauth/{{$row->id}}" title="分配权限">
					<i class="Hui-iconfont">&#xe6df;</i></a> 

					<!-- <a style="text-decoration:none" class="ml-5" onClick="article_del('删除','10001')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a> -->
