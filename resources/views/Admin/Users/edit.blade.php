...
<article class="page-container">
	<form action="/adminuser/update" method="post" class="form form-horizontal" id="form-member-add">
       ...
       <div class="mws-form-message error">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$user->email}}" placeholder="" id="" name="email">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电话：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" value="{{$user->phone}}" placeholder="" id="" name="phone">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-8">
				<input type="radio" name="status" value="1" @if($user->status==1) checked @endif />开启 &nbsp
