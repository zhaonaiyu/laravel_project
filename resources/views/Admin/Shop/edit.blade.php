...
<article class="page-container">
	<form action="/shop_update" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
       ...
       <div class="mws-form-message error">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-xm-8">
				<input type="text" class="input-text" value="{{$shop->name}}" placeholder="" id="username" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>类别：</label>
			<div class="formControls col-xs-8 col-xm-8">
				<select name="cate_id" value="{{$shop->cate_id}}" class="large" id="">
					<option value="">--请选择--</option>

					@foreach($cate as $value)
					@if($shop->cate_id==$value->id)
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-xm-8">
				<input type="text" class="input-text" value="{{$shop->num}}" placeholder="" id="" name="num">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-xm-8">
				<input type="text" class="input-text" value="{{$shop->price}}" placeholder="" id="" name="price">
			</div>
		</div>
